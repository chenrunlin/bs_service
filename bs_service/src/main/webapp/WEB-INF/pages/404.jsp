...
<head>
<HEAD>
<TITLE>Freedom LiFe提醒您：您访问的页面不存在 请转到首页进入</TITLE>
...
<BODY topMargin=150px;>
	<TABLE cellSpacing=0 width=600 align=center border=0 cepadding="0">
		<TBODY>
			<TR colspan="2">
				<TD vAlign=middle align=middle><IMG height=100 src="${pageContext.request.contextPath}/static/images/icon/404.jpg"
					width=100 border=0>
				<TD>
				<TD>
					<!--------System Return Begin------------>
